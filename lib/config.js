...
// Novedades del 21/09 en modo piloto: solo estas cuentas las ven hasta que se
// abran a todos (null = todos). Cada una se libera por separado.
const PILOTO = [ADMIN_EMAIL, 'luiszonycarlos18@gmail.com'];
