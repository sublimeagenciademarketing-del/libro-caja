...
export function diaAncla(item) {
  ...
  // fecha_esperada va antes que proximo_vencimiento: el próximo puede estar recortado (28/02) y perdería el 31.
  const base = item?.fecha_esperada || item?.proximo_vencimiento || item?.pagado_fecha || item?.cobrado_fecha;
