      ...
      <section style={{ textAlign: 'center', padding: '48px 24px 40px', maxWidth: 540, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'center' }}>
          <a href={`https://wa.me/${WA_NUMBER}?text=${waLink}`} target="_blank" rel="noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '15px 32px', borderRadius: 14, background: '#25d366', color: '#fff', fontWeight: 800, fontSize: 16, textDecoration: 'none', boxShadow: '0 4px 20px rgba(37,211,102,0.35)' }}>
          ...
          <a href="/login" style={{ fontSize: 13, color: 'rgba(255,255,255,0.3)', textDecoration: 'none' }}>Ya tengo cuenta → Ingresar</a>
        </div>
      </section>
